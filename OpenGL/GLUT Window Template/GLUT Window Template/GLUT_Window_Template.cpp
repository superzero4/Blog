...
char* window_title = new char[21] {'w', 'i', 'n', 'd', 'o', 'w' };
...
void drawObject()
{
	printf("Clearing and displaying object...\n");
...
void mouse(int button, int state, int x, int y)
{
	...
	case GLUT_LEFT_BUTTON:
		...
		switch (state)
		{
			//  Pressed 
		case GLUT_DOWN:
			printf("MouseClick Left Button Pressed (Down)...\n");
			break;
			//  Released
		case GLUT_UP:
			printf("MouseClick Left Button Released (Up)...\n");
			break;
		}
	...
	case GLUT_MIDDLE_BUTTON:
		...
		switch (state)
		{
			//  Pressed
		case GLUT_DOWN:
			printf("MouseClick Middle Button Pressed (Down)...\n");
			break;
			//  Released
		case GLUT_UP:
			printf("MouseClick Middle Button Released (Up)...\n");
			break;
		}
	...
	case GLUT_RIGHT_BUTTON:
		...
		switch (state)
		{
			//  Pressed
		case GLUT_DOWN:
			printf("MouseClick Right Button Pressed (Down)...\n");
			break;
			//  Released
		case GLUT_UP:
			printf("MouseClick Right Button Released (Up)...\n");
			break;
		}
...
void motion(int x, int y)
{
	...
	printf("MouseClick Drag Position: %d, %d.\n", x, y);
}
...
void pmotion(int x, int y)
{
	...
	printf("MouseClick Move Position: %d, %d.\n", x, y);
}
...
int main(int argc, char** argv)
{
	...
	glutDisplayFunc(MathMain::DisplayWrapper);
	glutReshapeFunc(reshape);
	//glutMouseFunc (mouse);
	glutMouseFunc (MathMain::MouseClickWrapper);
	glutMotionFunc(MathMain::MouseDragWrapper);
